...
<a href="zoom.html" target="_blank"><button class="button button1">Launch Meeting</button></a>
...
rs1.next();
%>
<tr><td><button type="submit" class="button button1"  value="<%=rs.getString("username") %>|<%=rs.getString("userid") %>" onclick="getval(this.value)"><%=rs.getString("username") %></button></td>
     ...
     <%}}catch(Exception e)
     {
    	 e.printStackTrace();
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
            <input type="Submit" value="Assign task" class="button button1">
            </div>
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <!-- <img src="assets/img/profile-img.jpg" class="img-fluid" alt="Image not found">
             ...
             <form action="head_profile" method="post" enctype="multipart/form-data">
             <label class="fst-italic">Upload Profile Image</label>
             <br/><br/>
             <input type="file" name="profile_img" >
             <input type="hidden" name="flag" value="0">
             <input type="submit" class="button button1" value="Upload" >
             </form>
          </div>
         ...
         <li><i class="bi bi-chevron-right"></i> <strong>Company Id:</strong> <span><%=rs.getString(12) %></span></li>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>E-mail:</strong> <span><%=rs.getString("email").toUpperCase() %></span></li> 
                  
                </ul>
              </div>
            </div><h3>Update Profile</h3>
            <a href="head_Update_details.jsp"><button  type="submit" class="button button1">Update</button></a>
          </div>
        </div>
<% }  
     }
...
{ Class.forName("com.mysql.jdbc.Driver");  
	...
	PreparedStatement ps=con.prepareStatement(sql);
	 ...
	 %>
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src=<%=epath2%> class="img-fluid" alt="img not found">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
    ...
    <!-- ======= Contact Section ======= -->
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          ...
          <br><br>
          <input type="hidden" value="head" name="trigger">
